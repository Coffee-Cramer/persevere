...
export const SWFTSTK7 = std.Spells.create('shrek6', 'SWFTSTK7')
    ...
    .Effects.addMod(eff => eff //do 84 physical damage
        .Type.SCHOOL_DAMAGE.set()
        .DamageBase.set(83) //84
        .ImplicitTargetA.UNIT_TARGET_ENEMY.set()
    )
    .Duration.setSimple(0)
    .Effects.addModTriggerSpell('shrek6', 'SWIFTSTRIKE_ENRAGE7', 0, eff => eff //grant 9 rage
        .Name.enGB.set("Rage")
        .Icon.set(1)
        .CastTime.set(0)
        .Range.set(0)
...
SWFTSTK7.Rank.set(SWFTSTK.ID, 5)
SWFTSTK7.SkillLines.add(AbilityCategory.Ronin.getSkill())