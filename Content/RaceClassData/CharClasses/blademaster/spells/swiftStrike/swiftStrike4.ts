...
export const SWFTSTK4 = std.Spells.create('shrek6', 'SWFTSTK4')
    ...
    .Effects.addMod(eff => eff //do 21 holy damage
        .Type.SCHOOL_DAMAGE.set()
        .DamageBase.set(20) 
        .ImplicitTargetA.UNIT_TARGET_ENEMY.set()
    )
    .Duration.setSimple(0)
    .Effects.addModTriggerSpell('shrek6', 'SWIFTSTRIKE_ENRAGE4', 0, eff => eff //grant 9 rage
        .Name.enGB.set("Rage")
        .Icon.set(1)
        .CastTime.set(0)
        .Range.set(0)
...
SWFTSTK4.Rank.set(SWFTSTK.ID, 4)
SWFTSTK4.SkillLines.add(AbilityCategory.Ronin.getSkill())