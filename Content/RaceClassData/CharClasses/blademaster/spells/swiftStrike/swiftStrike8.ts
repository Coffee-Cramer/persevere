...
export const SWFTSTK8 = std.Spells.create('shrek6', 'SWFTSTK8')
    ...
    .Effects.addMod(eff => eff 
        ...
        .DamageBase.set(100) //101
        .ImplicitTargetA.UNIT_TARGET_ENEMY.set()
    )
    .Duration.setSimple(0)
    .Effects.addModTriggerSpell('shrek6', 'SWIFTSTRIKE_ENRAGE8', 0, eff => eff //grant 9 rage
        .Name.enGB.set("Rage")
        .Icon.set(1)
        .CastTime.set(0)
        .Range.set(0)
...
SWFTSTK8.Rank.set(SWFTSTK.ID, 8)
SWFTSTK8.SkillLines.add(AbilityCategory.Ronin.getSkill())