...
export const SWFTSTK3 = std.Spells.create('shrek6', 'SWFTSTK3')
    ...
    .Effects.addMod(eff => eff //do 15 physical damage
        .Type.SCHOOL_DAMAGE.set()
        .DamageBase.set(14) 
        .ImplicitTargetA.UNIT_TARGET_ENEMY.set()
    )
    .Duration.setSimple(0)
    .Effects.addModTriggerSpell('shrek6', 'SWIFTSTRIKE_ENRAGE3', 0, eff => eff //grant 9 rage
        .Name.enGB.set("Rage")
        .Icon.set(1)
        .CastTime.set(0)
        .Range.set(0)
...
//how to find spell visual: console.log(std.Spells.load(69021).Visual.get())
SWFTSTK3.Rank.set(SWFTSTK.ID, 3)
SWFTSTK3.SkillLines.add(AbilityCategory.Ronin.getSkill())