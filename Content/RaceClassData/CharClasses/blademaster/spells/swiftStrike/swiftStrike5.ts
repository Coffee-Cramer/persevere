...
export const SWFTSTK5 = std.Spells.create('shrek6', 'SWFTSTK5')
    ...
    .Effects.addMod(eff => eff //do 33 holy damage
        .Type.SCHOOL_DAMAGE.set()
        .DamageBase.set(32) 
        .ImplicitTargetA.UNIT_TARGET_ENEMY.set()
    )
    .Duration.setSimple(0)
    .Effects.addModTriggerSpell('shrek6', 'SWIFTSTRIKE_ENRAGE5', 0, eff => eff //grant 9 rage
        .Name.enGB.set("Rage")
        .Icon.set(1)
        .CastTime.set(0)
        .Range.set(0)
...
SWFTSTK5.Rank.set(SWFTSTK.ID, 5)
SWFTSTK5.SkillLines.add(AbilityCategory.Ronin.getSkill())