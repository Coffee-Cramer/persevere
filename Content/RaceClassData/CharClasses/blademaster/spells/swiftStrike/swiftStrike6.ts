...
export const SWFTSTK6 = std.Spells.create('shrek6', 'SWFTSTK6')
    ...
    .Effects.addMod(eff => eff //do 60 physical damage
        .Type.SCHOOL_DAMAGE.set()
        .DamageBase.set(59) //60
        .ImplicitTargetA.UNIT_TARGET_ENEMY.set()
    )
    .Duration.setSimple(0)
    .Effects.addModTriggerSpell('shrek6', 'SWIFTSTRIKE_ENRAGE6', 0, eff => eff //grant 9 rage
        .Name.enGB.set("Rage")
        .Icon.set(1)
        .CastTime.set(0)
        .Range.set(0)
...
SWFTSTK6.Rank.set(SWFTSTK.ID, 5)
SWFTSTK6.SkillLines.add(AbilityCategory.Ronin.getSkill())