...
export const SWFTSTK9 = std.Spells.create('shrek6', 'SWFTSTK9')
    ...
    .Effects.addMod(eff => eff 
        ...
        .DamageBase.set(143) //144
        .ImplicitTargetA.UNIT_TARGET_ENEMY.set()
    )
    .Duration.setSimple(0)
    .Effects.addModTriggerSpell('shrek6', 'SWIFTSTRIKE_ENRAGE9', 0, eff => eff //grant 9 rage
        .Name.enGB.set("Rage")
        .Icon.set(1)
        .CastTime.set(0)
        .Range.set(0)
...
SWFTSTK9.Rank.set(SWFTSTK.ID, 9)
SWFTSTK9.SkillLines.add(AbilityCategory.Ronin.getSkill())


//console.log(std.Spells.load(78).objectify())
//console.log(std.Spells.load(72688).Visual.get())