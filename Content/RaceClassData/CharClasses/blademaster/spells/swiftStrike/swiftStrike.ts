...
export const SWFTSTK = std.Spells.create('shrek6', 'SWFTSTK')
    ...
    .Effects.addMod(eff => eff //do 3 physical damage
        .Type.SCHOOL_DAMAGE.set()
        .DamageBase.set(2) 
        .ImplicitTargetA.UNIT_TARGET_ENEMY.set()
    )
    .Effects.addModTriggerSpell('shrek6', 'SWIFTSTRIKE_ENRAGE', 0, eff => eff //grant 9 rage
        .Name.enGB.set("Rage")
        .Icon.set(1)
        .CastTime.set(0)
        .Range.set(0)
...
SWFTSTK.SkillLines.add(SWFITSTRIKE_OBJ.GetSkillLine())

//auto learn
std.Spells.load(SWFTSTK.ID).AutoLearn.add(1, BLDMSTR.Mask)


//DISENGAGE DEBUG
//console.log(std.Spells.load(68340).objectify())

//CRITICAL STRIKE DEBUG
//console.log(std.Spells.ID(CHAKRA))

//GHOST STRIKE VISUAL: 4159
//SWORD SPEC PROC VISUAL: 6560
//console.log(std.Spells.load(845).Visual.get())

//export const SWFTSTK_ARRAY = [ SWFTSTK, SWFTSTK2, SWFTSTK3, SWFTSTK4, SWFTSTK5, SWFTSTK6, SWFTSTK7]