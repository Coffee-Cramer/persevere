...
export const INCURSION = std.Spells.create('shrek6', 'INCURSION')
    ...
    .Description.enGB.set(INCURSION_OBJ.GetDesc() + "15 rage. Cannot be used in combat.")
    ...
    .Duration.setSimple(0) //Can be increased with Lash talent
    .Effects.addMod(x => x 
        .Type.WEAPON_PERCENT_DAMAGE.set()
        .DamagePctBase.set(109)
    ...
    .Effects.addModTriggerSpell('shrek6', 'INCURSION_ENRAGE', 0, eff => eff //grant 15 rage
        .Name.enGB.set("Rage")
        .Icon.set(1)
        .CastTime.set(0)
        .Range.set(0)
...
//console.log(std.Spells.load(2098).Visual.get())