...
const COMBAT_INTERRUPT_WINDWLK2 = std.Spells.create('shrek6', 'COMBAT_INTERRUPT_WINDWLK2')
...
export const WINDWLK2 = std.Spells.create('shrek6', 'WINDWLK2')
    //stealth attributes
    ...
    .Effects.addMod(x=>x 
        ...
        .AuraPeriod.set(1000)
        .TriggerSpell.set(COMBAT_INTERRUPT_WINDWLK2.ID)
        .ImplicitTargetA.UNIT_CASTER.set()
    )
...
WINDWLK2.Cooldown.Category.set(WINDWLK.ID)
.Cooldown.CategoryTime.set(30000)

//console.log("WINDWALK: ", std.Spells.ID(WINDWLK))
//console.log("WINDWALK 2: ", std.Spells.ID(WINDWLK2))
//console.log("WINDWALK 3: ",std.Spells.ID(WINDWLK3))
//console.log("WINDWALK 4: ",std.Spells.ID(WINDWLK4))
//console.log(std.Spells.ID(COMBAT_INTERRUPT_WINDWLK))