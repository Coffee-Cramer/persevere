...
const COMBAT_INTERRUPT_WINDWLK = std.Spells.create('shrek6', 'COMBAT_INTERRUPT_WINDWLK')
...
export const WINDWLK_WIND_VISUAL = std.Spells.create('shrek6', 'WINDWLK_WIND_VISUAL')
    .Tags.add('windwalkvis', 'windwalkvis')
    .Name.enGB.set("Windwalk Visual")
    .Icon.setPath("Spell_frost_windwalkon") 
    .Description.enGB.set("Melding into the wind.")
...
export const WINDWLK = std.Spells.create('shrek6', 'WINDWLK')
    //stealth attributes
    ...
    .Effects.addMod(x=>x 
        ...
        .AuraPeriod.set(1000)
        .TriggerSpell.set(COMBAT_INTERRUPT_WINDWLK.ID)
        .ImplicitTargetA.UNIT_CASTER.set()
    )
...
WINDWLK.Cooldown.Category.set(WINDWLK.ID)
.Cooldown.CategoryTime.set(WINDWALK_OBJ.GetCoolDown())


//console.log(std.Spells.load(6982).Visual.get())
//console.log(std.Spells.ID(WINDWLK_WIND_VISUAL))