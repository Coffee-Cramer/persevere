...
const COMBAT_INTERRUPT_WINDWLK3 = std.Spells.create('shrek6', 'COMBAT_INTERRUPT_WINDWLK3')
...
export const WINDWLK3 = std.Spells.create('shrek6', 'WINDWLK3')
    //stealth attributes
    ...
    .Effects.addMod(x=>x 
        ...
        .AuraPeriod.set(1000)
        .TriggerSpell.set(COMBAT_INTERRUPT_WINDWLK3.ID)
        .ImplicitTargetA.UNIT_CASTER.set()
    )
...
WINDWLK3.Cooldown.Category.set(WINDWLK.ID)
.Cooldown.CategoryTime.set(30000)


//console.log(std.Spells.load(65976).codify)