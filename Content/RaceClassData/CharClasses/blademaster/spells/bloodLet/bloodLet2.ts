...
//BLOOD LET RANK 2
export const BLET2 = std.Spells.create('shrek6', 'BLET2')
    ...
    .InlineScripts.OnPeriodicDamage((spell) => { 
        ...
        if(rstFt == 1){ //50% chance
            caster.ResetCooldown(81488) //Fatality
            caster.ResetCooldown(81487) //Pierce
            caster.ResetCooldown(80994) //Shock Blade
            caster.ResetCooldown(80918) //Blazing Strikes
        }
...
BLET2.SkillLines.add(AbilityCategory.Emp.getSkill())
//MONK_IMMOLATE_PUNCH2.StackGroups.add(MONK_IMMOLATE_PUNCH.ID)
//MONK_IMMOLATE_PUNCH2.StackGroups.add(MONK_IMMOLATE_PUNCH.ID)
BLET2.Rank.set(BLET.ID, 2)
