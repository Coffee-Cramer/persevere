...
//BLOOD LET RANK 7
export const BLET7 = std.Spells.create('shrek6', 'BLET7')
...
//MONK_BRUISE4.StackGroups.add(MONK_IMMOLATE_PUNCH.ID)
//MONK_BRUISE4.Rank.set(MONK_BRUISE4.ID, 4)
//console.log(std.Spells.load(20500).objectify())
BLET7.Rank.set(BLET.ID, 7)

BLET7.SkillLines.add(AbilityCategory.Emp.getSkill())