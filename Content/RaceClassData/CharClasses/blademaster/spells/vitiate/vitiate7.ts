...
export const VITIATE7 = std.Spells.create('shrek6', 'VITIATE7')
    ...
    .Effects.addModTriggerSpell('shrek6', 'VITIATE_ENRAGE7', 0, eff => eff //grant 9 rage
        .Name.enGB.set("Rage")
        .Icon.set(1)
        .CastTime.set(0)
        .Range.set(0)
...
VITIATE7.Rank.set(VITIATE.ID, 3)