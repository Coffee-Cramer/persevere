...
export const VITIATE2 = std.Spells.create('shrek6', 'VITIATE2')
    ...
    .Effects.addMod(eff => eff //do 13 physical damage
        .Type.SCHOOL_DAMAGE.set()
        .DamageBase.set(12) 
        .ImplicitTargetA.UNIT_TARGET_ENEMY.set()
    )
    .Effects.addModTriggerSpell('shrek6', 'VITIATE_ENRAGE2', 0, eff => eff //grant 9 rage
        .Name.enGB.set("Rage")
        .Icon.set(1)
        .CastTime.set(0)
        .Range.set(0)
...
VITIATE2.Rank.set(VITIATE.ID, 2)
