...
export const VITIATE5 = std.Spells.create('shrek6', 'VITIATE5')
    ...
    .Effects.addModTriggerSpell('shrek6', 'VITIATE_ENRAGE5', 0, eff => eff //grant 9 rage
        .Name.enGB.set("Rage")
        .Icon.set(1)
        .CastTime.set(0)
        .Range.set(0)
...
VITIATE5.Rank.set(VITIATE.ID, 3)
